...
const buildVerificationEmailHtml = (username, verificationLink) => {
  ...
  return `
    ...
    <body>
      <div class="container">
        <div class="header">
          <img src="${logoUrl}" alt="Khai Nguyên Pharma Logo">
        </div>
        <div class="content">
          <h1>Xác thực tài khoản</h1>
          <p>Xin chào ${username},</p>
          <p>Cảm ơn bạn đã đăng ký tài khoản tại Khai Nguyên Pharma. Vui lòng nhấn vào nút bên dưới để xác thực địa chỉ email và kích hoạt tài khoản của bạn:</p>
          <a href="${verificationLink}" class="button">Xác thực Email</a>
          <p>Nếu bạn không đăng ký tài khoản, vui lòng bỏ qua email này.</p>
          <p>Trân trọng,<br>Đội ngũ Khai Nguyên Pharma</p>
        </div>
        <div class="footer">
          <p>&copy; ${new Date().getFullYear()} Khai Nguyên Pharma. All rights reserved.</p>
        </div>
      </div>
    </body>
    </html>
