        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-3 gap-4">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="/blog" className="text-gray-700 hover:text-blue-600 uppercase font-medium text-sm">
                BLOG
              </Link>
              <Link href="/about-us" className="text-gray-700 hover:text-blue-600 uppercase font-medium text-sm">
                GIỚI THIỆU
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-6 text-sm">
              ...
              <Link href="/careers" className="text-white hover:text-blue-200 transition-colors">
                Tuyển Dụng
              </Link>
              ...
              <Link href="/services" className="text-white hover:text-blue-200 transition-colors">
                Dịch Vụ
              </Link>
              <Link href="/help" className="text-white hover:text-blue-200 transition-colors">
                Trợ Giúp
              </Link>
            </div>
